...
const Slide1 = () => {
  ...
  return (
    <section
      ref={containerRef}
      className={`${styles["slide-1"]} ${styles["slide"]} ${animateOnLoad ? styles["animate-bg"] : ""}`}
    >
      {/* Sky particles */}
      ...
      <div className={styles["slide-1-container"]}>
        ...
        >
          <div className={styles["slide-1-header"]}>
            ...
            <h1 ref={titleRef} className={`${styles["slide-1-title"]} ${animateOnLoad ? styles["title-animate"] : ""}`}>
          ...
          {/* 3D Vase - positioned with fixed dimensions and proper z-index */}
          <div
            className={`${styles["header-vase-container"]} ${animateOnLoad ? styles["vase-animate"] : ""} ${vaseLoaded ? styles["vase-loaded"] : ""}`}
            aria-hidden="true"
          >
            <div className={styles["vase-glow"]}></div>
            <LandingPageVase onLoaded={handleVaseLoaded} />
          </div>
